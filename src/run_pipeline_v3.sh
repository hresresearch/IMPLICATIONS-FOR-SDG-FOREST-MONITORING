...
.venv/bin/python3 prep_wdpa_v3.py
...
.venv/bin/python3 etl_fra_forest_pchip_v2.py
...
.venv/bin/python3 process_hansen_and_merge_v3.py \
...
.venv/bin/python3 build_figures.py
